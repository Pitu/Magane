...
<style scoped>
 ...
 div#magane div.stickerWindow div.handle {
	...
	base64,R0lGODlhEAAQALMAAP///+fn54eHh9ra2oaGhtzc3NfX19vb29XV1dnZ2QAAAAAAAAAAAAAAAAAAAAAAACH5BAEAAAAALAAAAAAQABAAAAQwEMhJq70Yl1wL4dNBBCAgkmAyAltmCKTnwsCwXi850BdC7zoLsPYTVIZIXmnJ5EQAADs=);
	 position: absolute;
	 width: 16px;
	 height: 16px;
	 left: -3px;
 ...
 div#magane div.stickerWindow > div.packs div.pack:hover, div#magane div.stickerWindow > div.packs div.pack.active {
	 transform: scale(1.25);
	 -webkit-transform: scale(1.25);
	 -webkit-filter: grayscale(0%);
	 filter: grayscale(0%);
 ...
 div#magane div.stickersConfig div.pack div.handle, div#magane div.stickersConfig div.pack div.preview, div#magane div.stickersConfig div.pack div.action {
	 flex: none;
	 width: 75px;
	 height: 75px;
}
 ...
 div#magane div.stickersModal .modal-content, div#magane div.stickersModal .modal-card {
 ...
 div#magane .tabs .tab:hover, div#magane .tabs .tab.is-active {
